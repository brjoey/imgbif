...
#' @param label label A `character` `vector` that contains the label for each class.
...
#' @note he app creates a folder for each label inside "sourceDir" and copies the images from "sourceDir" into the
